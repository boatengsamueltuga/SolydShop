/**
 * @file Category - Admin category management page
 * @description
 * - Displays all categories in an MUI DataGrid with edit and delete action buttons
 * - Uses useCategoryFilter hook to fetch and paginate categories via URL params
 * - Provides add/edit category forms via Globalmodal and AddCategoryForm
 * - Supports category deletion via DeleteModal with confirmation
 * - Shows Loader during fetch and empty state when no categories exist
 * @usage App.jsx -- route `/admin/categories` inside AdminLayout
 */
