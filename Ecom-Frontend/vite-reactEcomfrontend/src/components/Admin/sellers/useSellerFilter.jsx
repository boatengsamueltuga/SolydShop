/**
 * @file Seller filter hook — URL-driven data fetching for the admin seller panel.
 *
 * Reads `page` from URL search params → builds a 0-indexed query string → dispatches
 * `getAllSellersDashboard(queryString)`. Automatically re-fetches when params change.
 *
 * @usage Sellers.jsx — admin seller management page.
 */
